...
fetch("/assets/json/systems.json")
  ...
  .then((data_systems) => {
    ...
    for (let i = 0; i < sys.length; i++) {
      ...
      div.innerHTML = '<a href="/' + sys[i].url + '"><img src="https://cdn.glitch.me/9c8c96bb-a059-45d7-8b2b-d37ee6083aa6/' + sys[i].img + '-sys.png?v=1682444923996" style="width: 100%;"><div class="partners-overlay"><div class="partners-text"><b>' + sys[i].name + '</b>: ' + sys[i].desc + '</div></div><br></a><br></div>'
